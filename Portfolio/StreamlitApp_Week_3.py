...
MODEL_INFO = {
        ...
        "keys": ["DIS", "META", "DEXJPUS", "DEXUSUK", "^GSPC", "^IXIC", "^VIX"],
        "inputs": [{"name": k, "type": "number", "min": -1.0, "max": 1.0, "default": 0.0, "step": 0.01} for k in ["DIS", "META", "DEXJPUS", "DEXUSUK", "^GSPC", "^IXIC", "^VIX"]]
}
